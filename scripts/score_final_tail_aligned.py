...
from event_aligned_model import (
    feature_contract_sha256, score_dynamic_frame,
...
def score_file(
    ...
    contract = validate_dynamic_feature_contract(model, manifest.get("features"))
    contract_sha256 = feature_contract_sha256(contract)
    ...
    scores["feature_contract_sha256"] = contract_sha256
